            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all flex justify-center items-center flex-col space-y-7">
                ...
                <input
                  ...
                  className="border-[3px] border-gray-500 w-10/12 h-10 rounded p-5 font-semibold focus:outline-none focus:border-gray-800 placeholder:text-gray-500"
                ...
                <div className="w-10/12">
                  <input
                    ...
                    className="border-[3px] border-gray-500 w-full h-10 rounded p-5 font-semibold focus:outline-none focus:border-gray-800 placeholder:text-gray-500"
                    onChange={(e) => setPasswordValue(e.target.value)}
                  value={passwordValue}
                  />
                  <p className="text-right w-full mt-1 font-semibold">
                    Forgot password ?
                  </p>
                </div>
