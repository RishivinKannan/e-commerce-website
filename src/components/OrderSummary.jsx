  ...
  return (
    <div className=" bg-gray-50 w-[30rem] xl:w-[32rem] p-4 rounded-xl h-min space-y-4">
        ...
        <div className="flex w-full justify-between pb-4">
            ...
            <button className="rounded-3xl py-3 px-7 md:py-2 lg:py-3 md:px-4 lg:px-7 text-white bg-black text-lg font-bold tracking-wider">
                Apply
            </button>
        </div>
        <button className="w-full flex justify-center items-center gap-2 rounded-3xl py-3 px-6 text-white bg-black text-lg font-bold tracking-wider">
                Go to Checkout
                <LongRightArrowIcon/>
        </button>
    </div>
