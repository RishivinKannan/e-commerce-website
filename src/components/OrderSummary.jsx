...
function OrderSummary() {
  return (
    <div className=" bg-gray-50 w-[28rem] xl:w-[32rem] p-4 rounded-xl h-min outline outline-1 outline-gray-500 space-y-4">
        ...
        <div className="flex w-full justify-between  ">
            <input type="text" placeholder="Add Promo Code" className='rounded-3xl w-9/12 py-3 px-4 bg-lightest focus:outline-none' />
            <button className="rounded-3xl py-3 px-6 text-white bg-black text-lg font-bold tracking-wider">
                Apply
            </button>
        </div>
    </div>
