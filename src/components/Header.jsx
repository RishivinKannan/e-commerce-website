...
const Header = () => {
  ...
  function userAuthentication(userNameValue,passwordValue) {
    userDetails.provider({...userDetails,username:userNameValue,password:passwordValue});
    setLoggedIn(true);
    setLoginBox(false);
  }
  ...
  return (
    <div className="flex justify-between items-center p-6 bg-black text-white ">
      ...
      <div
        className={`bg-black absolute top-20 w-full left-0 p-4 lg:max-2xl:static lg:max-2xl:w-96 lg:max-2xl:p-0 lg:max-2xl:block ${
          searchBox ? "" : "hidden"
        }`}
      >
        <div className="p-2 flex bg-white text-black lg:max-2xl:w-96 rounded-lg">
          <SearchIcon />
          <input
            type="text"
            placeholder="Search..."
          ...
          <Popover className="relative">
            {({ open }) => (
              <>
                ...
                >
                  <Popover.Panel className={`absolute z-[100] text-black w-80  right-0 mt-1 top-20`}>
                    <div className="overflow-hidden rounded-lg shadow-xl ring-1 ring-black/5">
                      ...
                      <div className="py-2">
                        <ul>
                          <li className="px-4 py-2 font-semibold hover:bg-gray-300 hover:text-gray-600">Account</li>
                          <li className="px-4 py-2 font-semibold hover:bg-gray-300 hover:text-gray-600">Orders</li>
                          <li className="px-4 py-2 font-semibold hover:bg-gray-300 hover:text-gray-600">History</li>
                          <li className="px-4 py-2 font-semibold hover:bg-gray-300 hover:text-gray-600">Saved Address</li>
                          <li className="px-4 py-2 font-semibold hover:bg-gray-300 hover:text-gray-600"
                          onClick={()=>setLoggedIn(false)}>Logout</li>
                        </ul>
                      </div>
